...
app.controller('DARFCtrl2', ['$scope','$routeParams', '$rootScope', '$location','DARFSrvc2', 'AlertApp', 'MENSAGEM', 'TIPO_ALERTAS', 'RetencaoSrvc', 'UFSrvc', 'MunicipioSrvc','TipoSrvc','RiscoSrvc',
function($scope, $routeParams,  $rootScope, $location, service, alertApp, TIPO_ALERTAS, MENSAGEM, retencaoService, ufService, municipioService, tipoService, riscoService) {
	...
	// controller para tetes de acesso ao API Manager WSO2 com cabeçalho Authorization contendo o Acess Token
